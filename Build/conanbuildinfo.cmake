...
set(CONAN_CATCH2_ROOT "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_CATCH2 "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_CATCH2 "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib")
set(CONAN_BIN_DIRS_CATCH2 )
set(CONAN_RES_DIRS_CATCH2 )
set(CONAN_SRC_DIRS_CATCH2 )
set(CONAN_BUILD_DIRS_CATCH2 "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
set(CONAN_INCLUDE_DIRS "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_LIBS  ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "/root/.conan/data/catch2/2.4.2/bincrafters/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_CATCH2_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_CATCH2_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_CATCH2_RELWITHDEBINFO "" "relwithdebinfo" catch2)
    conan_package_library_targets("${CONAN_LIBS_CATCH2_MINSIZEREL}" "${CONAN_LIB_DIRS_CATCH2_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_CATCH2_MINSIZEREL "" "minsizerel" catch2)
    ...
    set_property(TARGET CONAN_PKG::catch2 PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_CATCH2} ${CONAN_SHARED_LINKER_FLAGS_CATCH2_LIST} ${CONAN_EXE_LINKER_FLAGS_CATCH2_LIST}
                                                                 ...
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_CATCH2_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_CATCH2_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_CATCH2_RELWITHDEBINFO_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_CATCH2_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_CATCH2_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_CATCH2_MINSIZEREL_LIST}>
    ...
    set(CONAN_TARGETS CONAN_PKG::catch2)
